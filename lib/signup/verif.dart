...
import 'package:megatel/login/languge.dart';

// Import the next screen file

class VerificationCodeScreen1 extends StatefulWidget {
  const VerificationCodeScreen1({Key? key, required verificationCode})
      : super(key: key);
...
class _VerificationCodeScreenState extends State<VerificationCodeScreen1> {
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
          builder: (context) => LanguageScreen(
              ...
              )), // Replace NextScreen() with the desired next screen
    );
  }
