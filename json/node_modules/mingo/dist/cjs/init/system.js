...
const accumulatorOperators = __importStar(require("../operators/accumulator"));
const expressionOperators = __importStar(require("../operators/expression"));
const pipelineOperators = __importStar(require("../operators/pipeline"));
...
const windowOperators = __importStar(require("../operators/window"));
